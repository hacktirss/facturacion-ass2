...
public class POSPeripheralPreProcessor extends BaseProcessor implements FacturaProcessor {

    private static final class Loader {
        static final POSPeripheralPreProcessor INSTANCE = new POSPeripheralPreProcessor();
    }

    public static POSPeripheralPreProcessor getInstance() {
        return Loader.INSTANCE;
    }

    private POSPeripheralPreProcessor() {}
    ...
    ComprobanteDetisa execute(ComprobanteDetisa comprobante) {
        ...
        try {
            return new FacturaDAO().cfdiPeripheralLastPosition(comprobante);
