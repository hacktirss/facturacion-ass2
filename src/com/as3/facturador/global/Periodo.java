...
public class Periodo implements FacturaPublicoGeneral {

    @Override
    public boolean createComprobantes() throws FacturacionException {
        return VariablesDAO.mustExecute() && new FacturaDAO().cfdiPublicoEnGeneralVentanaGlobal();
    }
    ...
    public void deslizaVentana() throws FacturacionException {
        ...
        VariablesDAO.slideWindowPeriodo();
    }
}
